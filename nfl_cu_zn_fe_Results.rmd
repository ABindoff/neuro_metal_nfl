...
An initial analysis investigated strain x age and strain x region interactions for each metal, in a model which accounted for region x age interactions. There were significant strain x age (Zn: F(1, 27) = 9, *p* = .005; Fe: F(1, 27) = 11, *p* = .002) and strain x region (Zn: F(5, 140) = 8, *p* < .001; Fe: F(5, 140) = 3, *p* = .021) interactions for Zn and Fe, but only the strain x region interaction was significant for Cu (F(5, 139) = 4, *p* = .002).
